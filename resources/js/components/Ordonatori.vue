...
<div>
    ...
    <div class="container-fluid">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Adaugare Ordonator de credite</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success">Salveaza Ordonator</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-1">
            <div class="col-3 my-2" v-for="ordonator in ordonatori" :key="ordonator.id">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center p-2 orange-label text-white">{{ ordonator.denumire}}</h5>
                        ...
                        <div class="box-institutie">
                            <div>Institutii</div>
                            <div><a v-bind:href="'/ordonator/' + ordonator.id" class="btn orange-label-slower btn-sm btn-block">Institutii</a></div>
                        </div>
                    </div>
                </div>
            </div>
